...
//   }
  ...
  if(empty($errors)){
    ...
    $statement = $pdo->prepare("INSERT INTO clubrooms (room_id, block, image, type, capacity, price, size) VALUES(:room_id, :block, :image, :type, :capacity,:price, :size)");
...
<html lang="en">
  ...
  <div class="cont">
    ...
    <p><a href="addvenue.php" class="btn btn-secondary">Back to Venue Details</a></p>
    <h3>Add Venue</h3>
