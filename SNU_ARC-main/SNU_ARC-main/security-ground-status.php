				...
				<div class="col-lg-4 col-md-6 text-center <?php echo $item["sport"]?>">
					<div class="single-product-item">
						...
						<?php 
							...
							{
								echo'<a class="cart-btn2 security-ground-button" data-venue='.$item["venue_id"].'> Unavailable</a>';
							}
							else{
								echo'<a class="cart-btn1 security-ground-button" data-venue='.$item["venue_id"].'> Available</a>';
							}
						?>
                        </div>
