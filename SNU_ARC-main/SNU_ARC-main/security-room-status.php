				...
				<div class="col-lg-4 col-md-6 text-center <?php echo $item["size"]?>">
					<div class="single-product-item">
						...
						if($item["type"]=="available") { 
								echo'<a class="cart-btn1 security-room-button" data-room='.$item["room_id"].'> Available</a>';
							}
						else{
							echo'<a class="cart-btn2 security-room-button" data-room='.$item["room_id"].'> Unavailable</a>';
							}
						?>
