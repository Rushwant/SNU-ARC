...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM security WHERE security_email='$email' AND security_password='$password'";
	...
	if (mysqli_num_rows($result) > 0) {
		$row = mysqli_fetch_assoc($result);
		$_SESSION['username'] = $row['security_name'];
		$_SESSION['password']=$row['security_password'];	
		$_SESSION['id']=$row['sec_id'];	
		$_SESSION['email'] = $row['security_email'];
...
?>
	...
	<div class="box_center">			
		<div class="card single-accordion">
							...
							<div class="cl1">
								<div class="cl2">
							<a href="security-register.php" class="breadcrumbb-text" ><p style="font-size: large;">Register </p></a>&nbsp;<p style="color:black; font-size:large;"><b>If you don't have an account</b></p></div></div>
		</div>
